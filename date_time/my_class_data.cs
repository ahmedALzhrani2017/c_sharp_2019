...
namespace date_time
{
    class my_class_data
    {
        public static void my_function_date_1()

        {
            Console.WriteLine("-----------------my_function_date_1----------------------");
        ...
        {
            Console.WriteLine("-----------------my_function_date_2----------------------");
            DateTime dt;
        ...
        {
            Console.WriteLine("-----------------my_function_date_3----------------------");
            DateTime dt = DateTime.Now;           
            Console.WriteLine(dt);
        }
        public static void my_function_date_4()
        {
            Console.WriteLine("-----------------my_function_date_4----------------------");
